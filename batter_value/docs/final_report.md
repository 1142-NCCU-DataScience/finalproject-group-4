...
> 📊 **圖 1 — 資料管線流程圖**  
> `../code/figures/poster/fig_pipeline.png`  
> 🏆 **海報重點圖** ｜ 📑 **期末簡報必放**

![資料管線流程圖](../code/figures/poster/fig_pipeline.png)
...
> 📊 **圖 2 — 時間切分策略**  
> `../code/figures/poster/fig_timesplit.png`  
> 🏆 **海報重點圖** ｜ 📑 **期末簡報必放**

![時間切分策略](../code/figures/poster/fig_timesplit.png)
...
> 📊 **圖 3 — 主要打擊指標分布直方圖**  
> `../code/figures/eda_distributions.png`  
> 📑 **期末簡報用**

![主要打擊指標分布](../code/figures/eda_distributions.png)
...
> 📊 **圖 4 — 打擊指標相關係數熱圖**  
> `../code/figures/eda_correlation.png`  
> 📑 **期末簡報用**

![打擊指標相關係數熱圖](../code/figures/eda_correlation.png)
...
> 📊 **圖 5 — wRC+ 前 20 名打者排名**  
> `../code/figures/fig1_wrcplus_ranking.png`  
> 📑 **期末簡報用**

![wRC+ 排名](../code/figures/fig1_wrcplus_ranking.png)
...
> 📊 **圖 6 — WAR vs wRC+ 四象限**  
> `../code/figures/fig2_war_vs_wrcplus.png`  
> 🏆 **海報重點圖** ｜ 📑 **期末簡報必放**

![WAR vs wRC+ 四象限](../code/figures/fig2_war_vs_wrcplus.png)
...
> `../code/figures/fig4_heatmap_all.png`  
> 🏆 **海報重點圖** ｜ 📑 **期末簡報必放**

![三球員熱區圖](../code/figures/fig4_heatmap_all.png)
...
> 📊 **圖 8 — 打擊結果進壘點分布**  
> `../code/figures/fig5_heatmap_by_result.png`  
> 📑 **期末簡報用**

![打擊結果分色](../code/figures/fig5_heatmap_by_result.png)
...
> `../code/figures/fig10_judge_power_vs_weak.png`  
> 📑 **期末簡報用**

![Judge 強弱區](../code/figures/fig10_judge_power_vs_weak.png)
...
> `../code/figures/fig9_xba_vs_ba.png`  
> 📑 **期末簡報用（補充分析）**

![xBA vs BA](../code/figures/fig9_xba_vs_ba.png)
...
> 📊 **圖 11 — 明星打者能力雷達圖**  
> `../code/figures/poster/fig_radar_stars.png`  
> 📑 **期末簡報用（補充）**

![明星雷達圖](../code/figures/poster/fig_radar_stars.png)
...
> `../code/figures/poster/fig_perm_importance.png`  
> 🏆 **海報重點圖** ｜ 📑 **期末簡報必放**

![特徵重要性](../code/figures/poster/fig_perm_importance.png)
...
> `../code/figures/poster/fig_actual_vs_pred.png`  
> 🏆 **海報重點圖** ｜ 📑 **期末簡報必放**

![實際 vs 預測](../code/figures/poster/fig_actual_vs_pred.png)
...
> 📊 **圖 14 — 訓練年數比較**  
> `../code/figures/model_ours/train_year_comparison.png`

![訓練年數比較](../code/figures/model_ours/train_year_comparison.png)
...
> `../code/figures/model_ours/eval_models_mae_test.png`（位於 `../code/figures/model_ours/`）
...
> `../code/figures/model_ours/eval_en3yr_coef.png`

![ElasticNet 係數](../code/figures/model_ours/eval_en3yr_coef.png)
...
> `../code/figures/model_ours/rnn/rnn_vs_all_mae.png`

![全模型比較](../code/figures/model_ours/rnn/rnn_vs_all_mae.png)
...
> `../code/figures/model_ours/eval_en3yr_error_by_tier.png`

![分層誤差](../code/figures/model_ours/eval_en3yr_error_by_tier.png)
...
> 📊 **圖 19 — 三模型分層 MAE 比較**  
> `../code/figures/model_ours/final_tier_comparison.png`

![三模型分層比較](../code/figures/model_ours/final_tier_comparison.png)
...
> `../code/figures/walkforward/eval_elasticnet_walkforward.png`

![Walk-Forward](../code/figures/walkforward/eval_elasticnet_walkforward.png)
...
| 圖 | 檔案 | 說明 |
|----|------|------|
| **管線流程** | `../code/figures/poster/fig_pipeline.png` | 讓觀眾快速理解整體研究設計 |
| **時間切分** | `../code/figures/poster/fig_timesplit.png` | 展示避免資料洩漏的嚴謹設計 |
| **WAR vs wRC+** | `../code/figures/fig2_war_vs_wrcplus.png` | 直觀展示球員價值分布與分群 |
| **熱區圖** | `../code/figures/fig4_heatmap_all.png` | 視覺衝擊力強，吸引非棒球觀眾 |
| **特徵重要性** | `../code/figures/poster/fig_perm_importance.png` | 展示模型核心發現 |
| **實際 vs 預測** | `../code/figures/poster/fig_actual_vs_pred.png` | 呈現模型表現與限制 |

### 📑 期末簡報（Slides）完整圖單

| 章節 | 圖 | 檔案 |
|------|-----|------|
| 方法論 | 圖 1 管線流程 | `../code/figures/poster/fig_pipeline.png` |
| 方法論 | 圖 2 時間切分 | `../code/figures/poster/fig_timesplit.png` |
| EDA | 圖 3 指標分布 | `../code/figures/eda_distributions.png` |
| EDA | 圖 4 相關係數熱圖 | `../code/figures/eda_correlation.png` |
| EDA | 圖 5 wRC+ 排名 | `../code/figures/fig1_wrcplus_ranking.png` |
| EDA | 圖 6 WAR vs wRC+ | `../code/figures/fig2_war_vs_wrcplus.png` |
| 熱區 | 圖 7 三球員熱區 | `../code/figures/fig4_heatmap_all.png` |
| 熱區 | 圖 8 打擊結果分色 | `../code/figures/fig5_heatmap_by_result.png` |
| 熱區 | 圖 9 Judge 強弱區 | `../code/figures/fig10_judge_power_vs_weak.png` |
| 補充 | 圖 10 xBA vs BA | `../code/figures/fig9_xba_vs_ba.png` |
| 分群 | 圖 11 雷達圖 | `../code/figures/poster/fig_radar_stars.png` |
| 模型 | 圖 12 特徵重要性 | `../code/figures/poster/fig_perm_importance.png` |
| 模型 | 圖 13 實際 vs 預測 | `../code/figures/poster/fig_actual_vs_pred.png` |

> ⚠️ **不建議在簡報/海報中使用：**  
> - `../code/figures/fig6_model_comparison.png`（同年 5-fold CV，R²≈0.86 嚴重誤導，是舊的同年預測模型）  
> - `../code/figures/fig7_feature_importance.png`（同年 MDI，OBP/SLG 主導，非 lag 特徵）  
> - `../code/figures/fig8_actual_vs_predicted.png`（同年模型 scatter，非 hold-out 預測）
