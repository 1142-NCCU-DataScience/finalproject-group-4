...
> 📊 **圖 14 — 訓練年數比較**  
> `model_ours/train_year_comparison.png`

![訓練年數比較](model_ours/train_year_comparison.png)
...
> `model_ours/eval_models_mae_test.png`（位於 `ds_final/figures/evaluation/`）
...
> `model_ours/eval_en3yr_coef.png`

![ElasticNet 係數](model_ours/eval_en3yr_coef.png)
...
> `model_ours/rnn/rnn_vs_all_mae.png`

![全模型比較](model_ours/rnn/rnn_vs_all_mae.png)
...
> `model_ours/eval_en3yr_error_by_tier.png`

![分層誤差](model_ours/eval_en3yr_error_by_tier.png)
...
> 📊 **圖 19 — 三模型分層 MAE 比較**  
> `model_ours/final_tier_comparison.png`

![三模型分層比較](model_ours/final_tier_comparison.png)
...
> `walkforward/eval_elasticnet_walkforward.png`

![Walk-Forward](walkforward/eval_elasticnet_walkforward.png)
