...
| `results/figures/model_ours/train_year_comparison.png` | 訓練年數比較圖 |
| `results/figures/model_ours/eval_en3yr_coef.png` | ElasticNet 係數圖 |
| `results/figures/model_ours/eval_en3yr_error_by_tier.png` | 分層誤差圖 |
| `results/figures/model_ours/final_mae_comparison.png` | 全模型整體 MAE 比較 |
| `results/figures/model_ours/final_tier_comparison.png` | 全模型分層 MAE 比較 |
| `results/figures/model_ours/rnn/rnn_vs_all_mae.png` | LSTM vs 其他模型 MAE |
